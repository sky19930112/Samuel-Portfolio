...
function Contact() {
    return (
      <motion.section initial={{width:0}} animate={{width:"100%"}} exit={{x:"100%", transition:{duration:0.1}}}
      name='contact' className='w-full h-screen bg-[#0e2779] flex justify-center items-center p-4'>
